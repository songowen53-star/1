// GET /api/practice/hotpoints/:subject/trend?years= — 命题趋势
// 对应后端 backend/routes/practice-hotpoints.js 中的 router.get('/:subject/trend')
...
export async function onRequestGet({ params, request }) {
    try {
        ...
        return Response.json({ code: 1, msg: '加载命题趋势失败: ' + e.message }, { status: 500 });
    }
}

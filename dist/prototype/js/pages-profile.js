...
registerPage('profile-main', '我的', '个人中心', 'fa-user', function () {
    ...
    function renderPageContent(container, data) {
        ...
        var subEntries = [
            ...
            { icon: 'fa-medal',         bg: '#FEE2E2', color: '#EF4444', label: '勋章墙',     page: '',                desc: '我的成就' },
        ...
        subEntries.forEach(function (e) {
            // 未注册页面改为 Toast 提示，避免跳转到空白
            var click = e.page ? `navigateTo('${e.page}')` : `showToast('${e.label}：功能开发中，敬请期待')`;
            html += `
                <div style="text-align:center;cursor:pointer;" onclick="${click}">
